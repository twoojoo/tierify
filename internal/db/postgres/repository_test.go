...
func TestMain(m *testing.M) {
	...
	testDSN = "postgres://test:test@localhost:15432/tierify_test?sslmode=disable"
...
// newTestRepos creates fresh repositories with a clean database for each test.
func newTestRepos(t *testing.T) *repositories.Repositories {
	t.Helper()

	// Drop all tables to get a clean state before migrations run.
	db, err := sql.Open("pgx", testDSN)
	require.NoError(t, err)
	defer db.Close()

	_, err = db.Exec(`
		DROP TABLE IF EXISTS transaction_operations CASCADE;
		DROP TABLE IF EXISTS transactions CASCADE;
		DROP TABLE IF EXISTS usage_records CASCADE;
		DROP TABLE IF EXISTS tenant_tier_history CASCADE;
		DROP TABLE IF EXISTS tenants CASCADE;
		DROP TABLE IF EXISTS limit_definitions CASCADE;
		DROP TABLE IF EXISTS tiers CASCADE;
		DROP TABLE IF EXISTS schema_migrations CASCADE;
	`)
	require.NoError(t, err)

	repos, err := NewRepositories(testDSN, 5, 2, time.Minute)
	require.NoError(t, err)
	return repos
}
...
func TestPostgres_TierCRUD(t *testing.T) {
...
func TestPostgres_LimitDefinitions(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_TenantHierarchy(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_TenantDelete_Cascade(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_TenantDelete_Orphan(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_UsageCRUD(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_UsageWithTimeWindow(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_TransactionCRUD(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_TierHistory(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_ListByTierID(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_HierarchyAncestors_Deep(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
...
func TestPostgres_HierarchyUsage_GlobalScope(t *testing.T) {
	repos := newTestRepos(t)
	ctx := context.Background()
